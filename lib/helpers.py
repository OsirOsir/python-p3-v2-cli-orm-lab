...
def find_employee_by_name():
    ...
    print(employee) if employee else print(f"Employee named {employee} not found")
...
def find_employee_by_id():
    ...
    print(employee) if employee else print(f"Employee id {id_} not found")
...
def create_employee():
    ...
    try:
        ...
        print(f"Employee created succesfully: {employee}")
    
    except Exception as exc:
        print("Error adding employee: ", exc)
...
def update_employee():
    ...
    if employee := Employee.find_by_id(id_):
        try:
            ...
            employee.update()
            print(f"Employee details updated successfully: {employee}")
        except Exception as exc:
...
def delete_employee():
    ...
    if employee := Employee.find_by_id(id_):
        employee.delete()
        print(f"Employee id {id_} deleted")
    else:
        print(f"Employee id {id_} not found")
